...
export default function ComponentsPage() {
  ...
  return (
    <Layout>
      ...
      <main>
        <section className={clsx(themeBg(themeContext.theme), color)}>
          <div
            className={clsx(
          ...
          >
            ...
            <div className='mt-8 flex flex-wrap gap-2'>
              <Button
                onClick={() =>
                  toggleTheme(themeContext.theme, themeContext.setTheme)
                }
                variant={themeContext.theme === 'dark' ? 'light' : 'dark'}
              >
                Set to {themeContext.theme === 'dark' ? 'light' : 'dark'}
              </Button>
            ...
            <ol className='mt-8 space-y-6'>
              <li className='space-y-2'>
                ...
                <p
                  className={clsx(
                    '!mt-1 text-sm',
                    themeTextColor(themeContext.theme)
                  )}
                >
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  ...
                  <ButtonLink
                    variant='outline'
                    isDarkBg={themeContext.theme === 'dark'}
                    href='https://theodorusclarence.com'
                  >
                    Outline Variant
                  </ButtonLink>
